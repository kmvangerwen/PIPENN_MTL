...
if __name__ == "__main__":
    nargs = len(sys.argv)
    if nargs == 3:
        DatasetParams.USER_INPUT_FASTA_FILE = sys.argv[1]
        DatasetParams.USERDS_INPUT_DIR = './'
        DatasetParams.PREPARED_USERDS_FILE = sys.argv[2]
        print("USER_INPUT_FASTA_FILE:", DatasetParams.USER_INPUT_FASTA_FILE, " | PREPARED_USERDS_FILE: ", DatasetParams.PREPARED_USERDS_FILE)
    else:
