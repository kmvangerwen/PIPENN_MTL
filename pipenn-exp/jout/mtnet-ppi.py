...
def make1DModel():
    ...
    # x1 = makeDenseBlock(x1, 64, False)
    # x2 = makeDenseBlock(x2, 64, False)
    # x3 = makeDenseBlock(x3, 64, False)
    # x4 = makeDenseBlock(x4, 64, False)
    # x5 = makeDenseBlock(x5, 64, False)

    # x1 = makeDenseBlock(x1, 32, False)
    # x2 = makeDenseBlock(x2, 32, False)
    # x3 = makeDenseBlock(x3, 32, False)
    # x4 = makeDenseBlock(x4, 32, False)
    # x5 = makeDenseBlock(x5, 32, False)

    # x1 = makeDenseBlock(x1, 16, False)
    # x2 = makeDenseBlock(x2, 16, False)
    # x3 = makeDenseBlock(x3, 16, False)
    # x4 = makeDenseBlock(x4, 16, False)
    # x5 = makeDenseBlock(x5, 16, False)
