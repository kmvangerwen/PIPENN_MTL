...
def make1DModel():
    ...
    rsa = TimeDistributed(Dense(1, activation='sigmoid'), name='rsa')(x2)
    sheet = TimeDistributed(Dense(1, activation='sigmoid'), name='sheet')(x3)
    helix = TimeDistributed(Dense(1, activation='sigmoid'), name='helix')(x4)
    coil = TimeDistributed(Dense(1, activation='sigmoid'), name='coil')(x5)
